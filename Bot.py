...
async def start(event):
    ...
    await event.client.send_file(
        ...
        buttons=[
            ...
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/FantasyWorldTamil"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/tamilstatusfx")],
            [Button.url("❤️‍🔥 ɴᴇᴛᴡᴏʀᴋ 💫", "https://t.me/ANBE_SIVAM_NETWORK"), Button.url("❤️‍🔥 BRANDED ❤️‍🔥", "https://t.me/Anbesivam_Owner")]
        ]
    )
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ᴀs ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/Anbesivam_Owner)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ ʙʀᴀɴᴅᴇᴅ\n✪ ʏᴏᴜᴛᴜʙᴇ [ᴄʜᴀɴɴᴇʟ](https://youtube.com/)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
